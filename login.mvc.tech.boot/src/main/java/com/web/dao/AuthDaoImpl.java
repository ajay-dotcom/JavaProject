...
public class AuthDaoImpl implements  AuthDao{
	...
	public ProfileEntity findByEmail(String email) {
		String sql = "select * from profile_tb where email = ?";
	...
	public List<ProfileEntity> findAll() {
		String sql = "select * from profile_tb";
	...
	public ProfileEntity findByUsernamePass(String username, String password) {
		String sql = "select * from profile_tb where username =?  and password=?";
	...
	public void deleteByUsername(String username) {
		String sql = "delete from profile_tb where username =?";
	    jdbcTemplate.update(sql, new Object[] { username });
	}

	@Override
	public void saveProfile(ProfileEntity entity) {
		String sql = "insert into profile_tb(username,password,name,email,mobile,gender,ssn,doe) values(?,?,?,?,?,?,?,?)";
	...
	public void updateProfile(ProfileEntity entity) {
		String sql = "update profile_tb set name=?,email=?,mobile=? where pid=?";
